...
public class RequestHeaderCIQ extends AbstractBsRequestHeaderCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public RequestHeaderCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsRequestHeaderCQ myCQ) {
    ...
    public String keepScalarCondition(RequestHeaderCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(RequestHeaderCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(RequestHeaderCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(RequestHeaderCQ sq)
    ...
    protected String xinCB() { return RequestHeaderCB.class.getName(); }
    protected String xinCQ() { return RequestHeaderCQ.class.getName(); }
}
