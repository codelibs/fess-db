...
public class WebConfigToRoleTypeMappingDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_12199C14_0B90_42C8_85B1_E643A278AEC2", false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignRoleType() {
        ...
        return cfi("CONSTRAINT_A17D5", "roleType", this, RoleTypeDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "webConfigToRoleTypeMappingList", false);
    }
    /**
    ...
    public ForeignInfo foreignWebCrawlingConfig() {
        ...
        return cfi("CONSTRAINT_A17D", "webCrawlingConfig", this, WebCrawlingConfigDbm.getInstance(), mp, 1, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "webConfigToRoleTypeMappingList", false);
    }
