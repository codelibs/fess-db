...
public class DataConfigToLabelTypeMappingDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_89FC549D_E68E_4126_8705_1A9790A4F314", false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignDataCrawlingConfig() {
        ...
        return cfi("CONSTRAINT_5CE", "dataCrawlingConfig", this, DataCrawlingConfigDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "dataConfigToLabelTypeMappingList", false);
    }
    /**
    ...
    public ForeignInfo foreignLabelType() {
        ...
        return cfi("CONSTRAINT_5CE1", "labelType", this, LabelTypeDbm.getInstance(), mp, 1, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "dataConfigToLabelTypeMappingList", false);
    }
