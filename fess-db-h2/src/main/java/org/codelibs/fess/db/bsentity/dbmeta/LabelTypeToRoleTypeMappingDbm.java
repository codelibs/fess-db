...
public class LabelTypeToRoleTypeMappingDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_237BC3D6_3346_4711_A2D6_F01F62F3D630", false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignLabelType() {
        ...
        return cfi("CONSTRAINT_2C", "labelType", this, LabelTypeDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "labelTypeToRoleTypeMappingList", false);
    }
    /**
    ...
    public ForeignInfo foreignRoleType() {
        ...
        return cfi("CONSTRAINT_2C8", "roleType", this, RoleTypeDbm.getInstance(), mp, 1, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "labelTypeToRoleTypeMappingList", false);
    }
