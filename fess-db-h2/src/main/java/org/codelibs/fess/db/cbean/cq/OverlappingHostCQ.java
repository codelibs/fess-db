...
import org.codelibs.fess.db.cbean.cq.bs.BsOverlappingHostCQ;
...
public class OverlappingHostCQ extends BsOverlappingHostCQ {
     ...
     */
    public OverlappingHostCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
