...
public class FailureUrlDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_B9C428F2_D410_4B21_9203_D58D292F1C1A", false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnErrorLog = cci("ERROR_LOG", "ERROR_LOG", null, null, String.class, "errorLog", null, false, false, false, "VARCHAR", 4000, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnErrorCount = cci("ERROR_COUNT", "ERROR_COUNT", null, null, Integer.class, "errorCount", null, false, false, true, "INTEGER", 10, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnLastAccessTime = cci("LAST_ACCESS_TIME", "LAST_ACCESS_TIME", null, null, java.time.LocalDateTime.class, "lastAccessTime", null, false, false, true, "TIMESTAMP", 23, 10, null, false, null, null, null, null, null, false);
