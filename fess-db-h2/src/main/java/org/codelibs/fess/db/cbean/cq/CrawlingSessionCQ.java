...
import org.codelibs.fess.db.cbean.cq.bs.BsCrawlingSessionCQ;
...
public class CrawlingSessionCQ extends BsCrawlingSessionCQ {
     ...
     */
    public CrawlingSessionCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
