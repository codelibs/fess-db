...
public class OverlappingHostDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_69D92682_8C0B_4C9D_87DD_0F31FE3CAE88", false, null, null, null, null, null, false);
    protected final ColumnInfo _columnRegularName = cci("REGULAR_NAME", "REGULAR_NAME", null, null, String.class, "regularName", null, false, false, true, "VARCHAR", 1000, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnOverlappingName = cci("OVERLAPPING_NAME", "OVERLAPPING_NAME", null, null, String.class, "overlappingName", null, false, false, true, "VARCHAR", 1000, 0, null, false, null, null, null, null, null, false);
