...
public class ClickLogDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_1F6E7F90_E9D3_4299_8A84_89F575447C93", false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignSearchLog() {
        ...
        return cfi("CONSTRAINT_310", "searchLog", this, SearchLogDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "clickLogList", false);
    }
