...
import org.codelibs.fess.db.cbean.cq.bs.BsFileCrawlingConfigCQ;
...
public class FileCrawlingConfigCQ extends BsFileCrawlingConfigCQ {
     ...
     */
    public FileCrawlingConfigCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
