...
import org.codelibs.fess.db.cbean.cq.bs.BsSuggestBadWordCQ;
...
public class SuggestBadWordCQ extends BsSuggestBadWordCQ {
     ...
     */
    public SuggestBadWordCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
