 ...
 */
public abstract class AbstractBsFileAuthenticationCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsFileAuthenticationCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setFileCrawlingConfigId_RangeOf(Long minNumber, Long maxNumber, ConditionOptionCall<RangeOfOption> opLambda) {
        setFileCrawlingConfigId_RangeOf(minNumber, maxNumber, xcROOP(opLambda));
    }
     ...
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    protected void setFileCrawlingConfigId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueFileCrawlingConfigId(), "FILE_CRAWLING_CONFIG_ID", rangeOfOption);
    }
     ...
     */
    public void setFileCrawlingConfigId_InScope(Collection<Long> fileCrawlingConfigIdList) {
        doSetFileCrawlingConfigId_InScope(fileCrawlingConfigIdList);
    }

    protected void doSetFileCrawlingConfigId_InScope(Collection<Long> fileCrawlingConfigIdList) {
        regINS(CK_INS, cTL(fileCrawlingConfigIdList), xgetCValueFileCrawlingConfigId(), "FILE_CRAWLING_CONFIG_ID");
    }
     ...
     */
    public void setFileCrawlingConfigId_NotInScope(Collection<Long> fileCrawlingConfigIdList) {
        doSetFileCrawlingConfigId_NotInScope(fileCrawlingConfigIdList);
    }

    protected void doSetFileCrawlingConfigId_NotInScope(Collection<Long> fileCrawlingConfigIdList) {
        regINS(CK_NINS, cTL(fileCrawlingConfigIdList), xgetCValueFileCrawlingConfigId(), "FILE_CRAWLING_CONFIG_ID");
    }

    protected void regFileCrawlingConfigId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueFileCrawlingConfigId(), "FILE_CRAWLING_CONFIG_ID"); }
    protected abstract ConditionValue xgetCValueFileCrawlingConfigId();
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_Equal()</span>.max(new SubQuery&lt;FileAuthenticationCB&gt;() {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_NotEqual()</span>.max(new SubQuery&lt;FileAuthenticationCB&gt;() {
     *     public void query(FileAuthenticationCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;FileAuthenticationCB&gt;() {
     *     public void query(FileAuthenticationCB subCB) {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessThan()</span>.max(new SubQuery&lt;FileAuthenticationCB&gt;() {
     *     public void query(FileAuthenticationCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;FileAuthenticationCB&gt;() {
     *     public void query(FileAuthenticationCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;FileAuthenticationCB&gt;() {
     *     public void query(FileAuthenticationCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSSQOption<CB> op) {
        ...
        FileAuthenticationCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
    ...
    protected FileAuthenticationCB xcreateScalarConditionCB() {
        FileAuthenticationCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected FileAuthenticationCB xcreateScalarConditionPartitionByCB() {
        FileAuthenticationCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<FileAuthenticationCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
    ...
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        FileAuthenticationCB cb = new FileAuthenticationCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "ID";
     ...
     */
    public void myselfExists(SubQuery<FileAuthenticationCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        FileAuthenticationCB cb = new FileAuthenticationCB(); cb.xsetupForMyselfExists(this);
    ...
    protected String xabCQ() { return FileAuthenticationCQ.class.getName(); }
