...
public class BsRequestHeaderCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public RequestHeaderCB acceptPK(Long id) {
    ...
    public RequestHeaderCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected RequestHeaderCQ doGetConditionQuery() {
    ...
    protected RequestHeaderCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        RequestHeaderCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected RequestHeaderCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void union(UnionQuery<RequestHeaderCB> unionCBLambda) {
        final RequestHeaderCB cb = new RequestHeaderCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RequestHeaderCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<RequestHeaderCB> unionCBLambda) {
        final RequestHeaderCB cb = new RequestHeaderCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final RequestHeaderCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">requestHeaderBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">requestHeader</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">requestHeader</span>.<span style="color: #CC4747">getWebCrawlingConfig()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<RequestHeaderCQ> {
        protected WebCrawlingConfigCB.HpSpecification _webCrawlingConfig;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<RequestHeaderCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "REQUEST_HEADER"; }
        /**
        ...
        public HpSDRFunction<RequestHeaderCB, RequestHeaderCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RequestHeaderCB> sq, RequestHeaderCQ cq, String al, DerivedReferrerOption op)
    ...
    public RequestHeaderCB dreamCruiseCB() {
        ...
        cb.xsetupForDreamCruise((RequestHeaderCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<RequestHeaderCB> columnQuery(final SpecifyQuery<RequestHeaderCB> colCBLambda) {
    ...
    protected RequestHeaderCB xcreateColumnQueryCB() {
        RequestHeaderCB cb = new RequestHeaderCB();
        cb.xsetupForColumnQuery((RequestHeaderCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<RequestHeaderCB> orCBLambda) {
        xorSQ((RequestHeaderCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<RequestHeaderCB> andCBLambda) {
        xorSQAP((RequestHeaderCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return RequestHeaderCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return RequestHeaderCQ.class.getName(); }
