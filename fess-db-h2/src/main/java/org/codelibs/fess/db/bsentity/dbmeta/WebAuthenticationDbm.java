...
public class WebAuthenticationDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_723F18E8_0095_42E7_8111_84465A8AD48A", false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignWebCrawlingConfig() {
        ...
        return cfi("CONSTRAINT_A31", "webCrawlingConfig", this, WebCrawlingConfigDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "webAuthenticationList", false);
    }
