...
public class RequestHeaderDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_2097F65A_E7E8_479B_ACEA_CACAA19656FE", false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnValue = cci("VALUE", "VALUE", null, null, String.class, "value", null, false, false, true, "VARCHAR", 1000, 0, null, false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignWebCrawlingConfig() {
        ...
        return cfi("CONSTRAINT_A1", "webCrawlingConfig", this, WebCrawlingConfigDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "requestHeaderList", false);
    }
