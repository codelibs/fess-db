...
public class RoleTypeDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_BB9D32E6_69EC_4E3B_88F9_BF75FBD8A66A", false, null, null, null, "dataConfigToRoleTypeMappingList,fileConfigToRoleTypeMappingList,labelTypeToRoleTypeMappingList,webConfigToRoleTypeMappingList", null, false);
    ...
    public ReferrerInfo referrerDataConfigToRoleTypeMappingList() {
        ...
        return cri("CONSTRAINT_E31", "dataConfigToRoleTypeMappingList", this, DataConfigToRoleTypeMappingDbm.getInstance(), mp, false, "roleType");
    }
    /**
    ...
    public ReferrerInfo referrerFileConfigToRoleTypeMappingList() {
        ...
        return cri("CONSTRAINT_3A9", "fileConfigToRoleTypeMappingList", this, FileConfigToRoleTypeMappingDbm.getInstance(), mp, false, "roleType");
    }
    /**
    ...
    public ReferrerInfo referrerLabelTypeToRoleTypeMappingList() {
        ...
        return cri("CONSTRAINT_2C8", "labelTypeToRoleTypeMappingList", this, LabelTypeToRoleTypeMappingDbm.getInstance(), mp, false, "roleType");
    }
    /**
    ...
    public ReferrerInfo referrerWebConfigToRoleTypeMappingList() {
        ...
        return cri("CONSTRAINT_A17D5", "webConfigToRoleTypeMappingList", this, WebConfigToRoleTypeMappingDbm.getInstance(), mp, false, "roleType");
    }
