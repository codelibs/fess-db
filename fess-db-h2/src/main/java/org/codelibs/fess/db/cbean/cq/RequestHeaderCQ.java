...
import org.codelibs.fess.db.cbean.cq.bs.BsRequestHeaderCQ;
...
public class RequestHeaderCQ extends BsRequestHeaderCQ {
     ...
     */
    public RequestHeaderCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
