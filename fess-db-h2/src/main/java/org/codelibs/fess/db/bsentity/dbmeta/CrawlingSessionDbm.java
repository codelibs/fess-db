...
public class CrawlingSessionDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_E403A5FE_3BE4_4A53_B259_4D44D5292418", false, null, null, null, "crawlingSessionInfoList", null, false);
    ...
    protected final ColumnInfo _columnExpiredTime = cci("EXPIRED_TIME", "EXPIRED_TIME", null, null, java.time.LocalDateTime.class, "expiredTime", null, false, false, false, "TIMESTAMP", 23, 10, null, false, null, null, null, null, null, false);
    ...
    public ReferrerInfo referrerCrawlingSessionInfoList() {
        ...
        return cri("CONSTRAINT_B3A", "crawlingSessionInfoList", this, CrawlingSessionInfoDbm.getInstance(), mp, false, "crawlingSession");
    }
