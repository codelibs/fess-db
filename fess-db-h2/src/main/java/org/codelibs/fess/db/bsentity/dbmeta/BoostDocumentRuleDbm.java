...
public class BoostDocumentRuleDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_757EB370_E725_445D_B15D_C19985C95AD5", false, null, null, null, null, null, false);
    protected final ColumnInfo _columnUrlExpr = cci("URL_EXPR", "URL_EXPR", null, null, String.class, "urlExpr", null, false, false, true, "VARCHAR", 4000, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnBoostExpr = cci("BOOST_EXPR", "BOOST_EXPR", null, null, String.class, "boostExpr", null, false, false, true, "VARCHAR", 4000, 0, null, false, null, null, null, null, null, false);
