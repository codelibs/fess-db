...
public class SearchFieldLogDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_311CF49E_B8CE_4687_80DE_F555D00EA661", false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignSearchLog() {
        ...
        return cfi("CONSTRAINT_96", "searchLog", this, SearchLogDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "searchFieldLogList", false);
    }
