...
public class FileConfigToRoleTypeMappingDbm extends AbstractDBMeta {
    ...
    public ForeignInfo foreignFileCrawlingConfig() {
        ...
        return cfi("FILE_CONFIG_TO_ROLE_TYPE_MAPPING_ibfk_1", "fileCrawlingConfig", this, FileCrawlingConfigDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "fileConfigToRoleTypeMappingList", false);
    }
    /**
    ...
    public ForeignInfo foreignRoleType() {
        ...
        return cfi("FILE_CONFIG_TO_ROLE_TYPE_MAPPING_ibfk_2", "roleType", this, RoleTypeDbm.getInstance(), mp, 1, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "fileConfigToRoleTypeMappingList", false);
    }
