...
import org.codelibs.fess.db.cbean.cq.bs.BsFavoriteLogCQ;
...
public class FavoriteLogCQ extends BsFavoriteLogCQ {
     ...
     */
    public FavoriteLogCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
