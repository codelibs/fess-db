...
public class FileAuthenticationDbm extends AbstractDBMeta {
    ...
    public ForeignInfo foreignFileCrawlingConfig() {
        ...
        return cfi("FILE_AUTHENTICATION_ibfk_1", "fileCrawlingConfig", this, FileCrawlingConfigDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "fileAuthenticationList", false);
    }
