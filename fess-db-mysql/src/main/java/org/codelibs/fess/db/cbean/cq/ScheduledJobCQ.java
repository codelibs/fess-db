...
import org.codelibs.fess.db.cbean.cq.bs.BsScheduledJobCQ;
...
public class ScheduledJobCQ extends BsScheduledJobCQ {
     ...
     */
    public ScheduledJobCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
