...
import org.codelibs.fess.db.cbean.cq.bs.BsSearchLogCQ;
...
public class SearchLogCQ extends BsSearchLogCQ {
     ...
     */
    public SearchLogCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
