...
public class WebCrawlingConfigDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, null, false, null, null, null, "requestHeaderList,webAuthenticationList,webConfigToLabelTypeMappingList,webConfigToRoleTypeMappingList", null, false);
    ...
    protected final ColumnInfo _columnUrls = cci("URLS", "URLS", null, null, String.class, "urls", null, false, false, true, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnIncludedUrls = cci("INCLUDED_URLS", "INCLUDED_URLS", null, null, String.class, "includedUrls", null, false, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnExcludedUrls = cci("EXCLUDED_URLS", "EXCLUDED_URLS", null, null, String.class, "excludedUrls", null, false, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnIncludedDocUrls = cci("INCLUDED_DOC_URLS", "INCLUDED_DOC_URLS", null, null, String.class, "includedDocUrls", null, false, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnExcludedDocUrls = cci("EXCLUDED_DOC_URLS", "EXCLUDED_DOC_URLS", null, null, String.class, "excludedDocUrls", null, false, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnConfigParameter = cci("CONFIG_PARAMETER", "CONFIG_PARAMETER", null, null, String.class, "configParameter", null, false, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnDepth = cci("DEPTH", "DEPTH", null, null, Integer.class, "depth", null, false, false, false, "INT", 10, 0, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnNumOfThread = cci("NUM_OF_THREAD", "NUM_OF_THREAD", null, null, Integer.class, "numOfThread", null, false, false, true, "INT", 10, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnIntervalTime = cci("INTERVAL_TIME", "INTERVAL_TIME", null, null, Integer.class, "intervalTime", null, false, false, true, "INT", 10, 0, null, false, null, null, null, null, null, false);
    ...
    public ReferrerInfo referrerRequestHeaderList() {
        ...
        return cri("REQUEST_HEADER_ibfk_1", "requestHeaderList", this, RequestHeaderDbm.getInstance(), mp, false, "webCrawlingConfig");
    }
    /**
    ...
    public ReferrerInfo referrerWebAuthenticationList() {
        ...
        return cri("WEB_AUTHENTICATION_ibfk_1", "webAuthenticationList", this, WebAuthenticationDbm.getInstance(), mp, false, "webCrawlingConfig");
    }
    /**
    ...
    public ReferrerInfo referrerWebConfigToLabelTypeMappingList() {
        ...
        return cri("WEB_CONFIG_TO_LABEL_TYPE_MAPPING_ibfk_2", "webConfigToLabelTypeMappingList", this, WebConfigToLabelTypeMappingDbm.getInstance(), mp, false, "webCrawlingConfig");
    }
    /**
    ...
    public ReferrerInfo referrerWebConfigToRoleTypeMappingList() {
        ...
        return cri("WEB_CONFIG_TO_ROLE_TYPE_MAPPING_ibfk_1", "webConfigToRoleTypeMappingList", this, WebConfigToRoleTypeMappingDbm.getInstance(), mp, false, "webCrawlingConfig");
    }
