...
public class SearchQueryRankingDbm extends AbstractDBMeta {
    ...
    public static SearchQueryRankingDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((SearchQueryRanking)et).getName(), (et, vl) -> ((SearchQueryRanking)et).setName((String)vl), "name");
        setupEpg(_epgMap, et -> ((SearchQueryRanking)et).getCnt(), (et, vl) -> ((SearchQueryRanking)et).setCnt(ctl(vl)), "cnt");
    }
    ...
    protected final String _tableDispName = "SearchQueryRanking";
    protected final String _tablePropertyName = "searchQueryRanking";
    protected final TableSqlName _tableSqlName = new TableSqlName("SearchQueryRanking", _tableDbName);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.codelibs.fess.db.exentity.customize.SearchQueryRanking"; }
    ...
    //                                                                         Object Type
    //                                                                         ===========
    public Class<SearchQueryRanking> getEntityType() { return SearchQueryRanking.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public SearchQueryRanking newEntity() { return new SearchQueryRanking(); }
