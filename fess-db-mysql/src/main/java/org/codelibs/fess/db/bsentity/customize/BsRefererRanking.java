...
public abstract class BsRefererRanking extends AbstractEntity implements CustomizeEntity {
    ...
    //                                                                           Attribute
    //                                                                           =========
    /** name: {VARCHAR(21845), refers to SEARCH_LOG.REFERER} */
    ...
    //                                                                            ========
    /**
     * [get] name: {VARCHAR(21845), refers to SEARCH_LOG.REFERER} <br>
    ...
    /**
     * [set] name: {VARCHAR(21845), refers to SEARCH_LOG.REFERER} <br>
