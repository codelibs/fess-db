...
public class JobLogDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnScriptResult = cci("SCRIPT_RESULT", "SCRIPT_RESULT", null, null, String.class, "scriptResult", null, false, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnStartTime = cci("START_TIME", "START_TIME", null, null, java.time.LocalDateTime.class, "startTime", null, false, false, true, "TIMESTAMP", 19, 0, "CURRENT_TIMESTAMP", false, null, null, null, null, null, false);
    protected final ColumnInfo _columnEndTime = cci("END_TIME", "END_TIME", null, null, java.time.LocalDateTime.class, "endTime", null, false, false, true, "TIMESTAMP", 19, 0, "0000-00-00 00:00:00", false, null, null, null, null, null, false);
