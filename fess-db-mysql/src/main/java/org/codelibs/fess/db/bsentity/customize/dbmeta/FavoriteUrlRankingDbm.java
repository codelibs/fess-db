...
public class FavoriteUrlRankingDbm extends AbstractDBMeta {
    ...
    public static FavoriteUrlRankingDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((FavoriteUrlRanking)et).getName(), (et, vl) -> ((FavoriteUrlRanking)et).setName((String)vl), "name");
        setupEpg(_epgMap, et -> ((FavoriteUrlRanking)et).getCnt(), (et, vl) -> ((FavoriteUrlRanking)et).setCnt(ctl(vl)), "cnt");
    }
    ...
    protected final String _tableDispName = "FavoriteUrlRanking";
    protected final String _tablePropertyName = "favoriteUrlRanking";
    protected final TableSqlName _tableSqlName = new TableSqlName("FavoriteUrlRanking", _tableDbName);
    ...
    /**
     * name: {VARCHAR(21845), refers to FAVORITE_LOG.URL}
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.codelibs.fess.db.exentity.customize.FavoriteUrlRanking"; }
    ...
    //                                                                         Object Type
    //                                                                         ===========
    public Class<FavoriteUrlRanking> getEntityType() { return FavoriteUrlRanking.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public FavoriteUrlRanking newEntity() { return new FavoriteUrlRanking(); }
