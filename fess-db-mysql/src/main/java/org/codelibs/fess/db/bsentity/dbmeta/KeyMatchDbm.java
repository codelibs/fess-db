...
public class KeyMatchDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnTerm = cci("TERM", "TERM", null, null, String.class, "term", null, false, false, true, "VARCHAR", 100, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnQuery = cci("QUERY", "QUERY", null, null, String.class, "query", null, false, false, true, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnMaxSize = cci("MAX_SIZE", "MAX_SIZE", null, null, Integer.class, "maxSize", null, false, false, true, "INT", 10, 0, null, false, null, null, null, null, null, false);
