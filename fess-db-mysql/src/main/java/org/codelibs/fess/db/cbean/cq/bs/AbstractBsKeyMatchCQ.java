...
public abstract class AbstractBsKeyMatchCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsKeyMatchCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    protected void doSetTerm_Equal(String term) {
        regTerm(CK_EQ, term);
    }
    ...
    protected void doSetTerm_NotEqual(String term) {
        regTerm(CK_NES, term);
    }
    ...
    protected void doSetTerm_InScope(Collection<String> termList) {
        regINS(CK_INS, cTL(termList), xgetCValueTerm(), "TERM");
    }
     ...
     */
    public void setTerm_NotInScope(Collection<String> termList) {
        doSetTerm_NotInScope(termList);
    }

    protected void doSetTerm_NotInScope(Collection<String> termList) {
        regINS(CK_NINS, cTL(termList), xgetCValueTerm(), "TERM");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * TERM: {NotNull, VARCHAR(100)} <br>
     * <pre>e.g. setTerm_LikeSearch("xxx", op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> op.<span style="color: #CC4747">likeContain()</span>);</pre>
     * @param term The value of term as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setTerm_LikeSearch(String term, ConditionOptionCall<LikeSearchOption> opLambda) {
        setTerm_LikeSearch(term, xcLSOP(opLambda));
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * TERM: {NotNull, VARCHAR(100)} <br>
     * <pre>e.g. setTerm_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param term The value of term as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    protected void setTerm_LikeSearch(String term, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(term), xgetCValueTerm(), "TERM", likeSearchOption);
    }
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setTerm_NotLikeSearch(String term, ConditionOptionCall<LikeSearchOption> opLambda) {
        setTerm_NotLikeSearch(term, xcLSOP(opLambda));
    }
     ...
     */
    protected void setTerm_NotLikeSearch(String term, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(term), xgetCValueTerm(), "TERM", likeSearchOption);
    }

    protected void regTerm(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueTerm(), "TERM"); }
    protected abstract ConditionValue xgetCValueTerm();
    ...
    protected void doSetQuery_Equal(String query) {
    ...
    protected void doSetQuery_NotEqual(String query) {
    ...
    protected void doSetQuery_InScope(Collection<String> queryList) {
        regINS(CK_INS, cTL(queryList), xgetCValueQuery(), "QUERY");
    }
     ...
     */
    public void setQuery_NotInScope(Collection<String> queryList) {
        doSetQuery_NotInScope(queryList);
    }

    protected void doSetQuery_NotInScope(Collection<String> queryList) {
        regINS(CK_NINS, cTL(queryList), xgetCValueQuery(), "QUERY");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * QUERY: {NotNull, TEXT(65535)} <br>
     * <pre>e.g. setQuery_LikeSearch("xxx", op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> op.<span style="color: #CC4747">likeContain()</span>);</pre>
     * @param query The value of query as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setQuery_LikeSearch(String query, ConditionOptionCall<LikeSearchOption> opLambda) {
        setQuery_LikeSearch(query, xcLSOP(opLambda));
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * QUERY: {NotNull, TEXT(65535)} <br>
     * <pre>e.g. setQuery_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param query The value of query as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    protected void setQuery_LikeSearch(String query, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(query), xgetCValueQuery(), "QUERY", likeSearchOption);
    }
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setQuery_NotLikeSearch(String query, ConditionOptionCall<LikeSearchOption> opLambda) {
        setQuery_NotLikeSearch(query, xcLSOP(opLambda));
    }
     ...
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    protected void setQuery_NotLikeSearch(String query, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(query), xgetCValueQuery(), "QUERY", likeSearchOption);
    }

    protected void regQuery(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueQuery(), "QUERY"); }
    protected abstract ConditionValue xgetCValueQuery();
    ...
    protected void doSetMaxSize_Equal(Integer maxSize) {
    ...
    protected void doSetMaxSize_NotEqual(Integer maxSize) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setMaxSize_RangeOf(Integer minNumber, Integer maxNumber, ConditionOptionCall<RangeOfOption> opLambda) {
        setMaxSize_RangeOf(minNumber, maxNumber, xcROOP(opLambda));
    }
     ...
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    protected void setMaxSize_RangeOf(Integer minNumber, Integer maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueMaxSize(), "MAX_SIZE", rangeOfOption);
    }
    ...
    protected void doSetMaxSize_InScope(Collection<Integer> maxSizeList) {
        regINS(CK_INS, cTL(maxSizeList), xgetCValueMaxSize(), "MAX_SIZE");
    }
     ...
     */
    public void setMaxSize_NotInScope(Collection<Integer> maxSizeList) {
        doSetMaxSize_NotInScope(maxSizeList);
    }

    protected void doSetMaxSize_NotInScope(Collection<Integer> maxSizeList) {
        regINS(CK_NINS, cTL(maxSizeList), xgetCValueMaxSize(), "MAX_SIZE");
    }

    protected void regMaxSize(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueMaxSize(), "MAX_SIZE"); }
    protected abstract ConditionValue xgetCValueMaxSize();
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_Equal()</span>.max(new SubQuery&lt;KeyMatchCB&gt;() {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_NotEqual()</span>.max(new SubQuery&lt;KeyMatchCB&gt;() {
     *     public void query(KeyMatchCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;KeyMatchCB&gt;() {
     *     public void query(KeyMatchCB subCB) {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessThan()</span>.max(new SubQuery&lt;KeyMatchCB&gt;() {
     *     public void query(KeyMatchCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;KeyMatchCB&gt;() {
     *     public void query(KeyMatchCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;KeyMatchCB&gt;() {
     *     public void query(KeyMatchCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSSQOption<CB> op) {
        ...
        KeyMatchCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
    ...
    protected KeyMatchCB xcreateScalarConditionCB() {
        KeyMatchCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected KeyMatchCB xcreateScalarConditionPartitionByCB() {
        KeyMatchCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<KeyMatchCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        KeyMatchCB cb = new KeyMatchCB(); cb.xsetupForDerivedReferrer(this);
    ...
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        KeyMatchCB cb = new KeyMatchCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "ID";
     ...
     */
    public void myselfExists(SubQuery<KeyMatchCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        KeyMatchCB cb = new KeyMatchCB(); cb.xsetupForMyselfExists(this);
    ...
    protected String xabCQ() { return KeyMatchCQ.class.getName(); }
