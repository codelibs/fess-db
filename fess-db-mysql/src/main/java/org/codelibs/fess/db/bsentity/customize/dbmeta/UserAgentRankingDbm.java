...
public class UserAgentRankingDbm extends AbstractDBMeta {
    ...
    public static UserAgentRankingDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((UserAgentRanking)et).getName(), (et, vl) -> ((UserAgentRanking)et).setName((String)vl), "name");
        setupEpg(_epgMap, et -> ((UserAgentRanking)et).getCnt(), (et, vl) -> ((UserAgentRanking)et).setCnt(ctl(vl)), "cnt");
    }
    ...
    protected final String _tableDispName = "UserAgentRanking";
    protected final String _tablePropertyName = "userAgentRanking";
    protected final TableSqlName _tableSqlName = new TableSqlName("UserAgentRanking", _tableDbName);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.codelibs.fess.db.exentity.customize.UserAgentRanking"; }
    ...
    //                                                                         Object Type
    //                                                                         ===========
    public Class<UserAgentRanking> getEntityType() { return UserAgentRanking.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public UserAgentRanking newEntity() { return new UserAgentRanking(); }
