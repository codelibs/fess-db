...
public class UserInfoDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, null, false, null, null, null, "favoriteLogList,searchLogList", null, false);
    protected final ColumnInfo _columnCode = cci("CODE", "CODE", null, null, String.class, "code", null, false, false, true, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    ...
    public ReferrerInfo referrerFavoriteLogList() {
        ...
        return cri("FAVORITE_LOG_ibfk_1", "favoriteLogList", this, FavoriteLogDbm.getInstance(), mp, false, "userInfo");
    }
    /**
    ...
    public ReferrerInfo referrerSearchLogList() {
        ...
        return cri("SEARCH_LOG_ibfk_1", "searchLogList", this, SearchLogDbm.getInstance(), mp, false, "userInfo");
    }
