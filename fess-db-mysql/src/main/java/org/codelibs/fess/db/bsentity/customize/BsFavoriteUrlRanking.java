 ...
 */
public abstract class BsFavoriteUrlRanking extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.codelibs.fess.db.bsentity.customize.dbmeta.FavoriteUrlRankingDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsFavoriteUrlRanking) {
            BsFavoriteUrlRanking other = (BsFavoriteUrlRanking)obj;
    ...
    //                                                                            ========
    /**
     * [get] name: {VARCHAR(21845), refers to FAVORITE_LOG.URL} <br>
    ...
    /**
     * [set] name: {VARCHAR(21845), refers to FAVORITE_LOG.URL} <br>
