...
import org.codelibs.fess.db.cbean.cq.bs.BsDataCrawlingConfigCQ;
...
public class DataCrawlingConfigCQ extends BsDataCrawlingConfigCQ {
     ...
     */
    public DataCrawlingConfigCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
