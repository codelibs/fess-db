...
import org.codelibs.fess.db.cbean.cq.bs.BsCrawlingSessionInfoCQ;
...
public class CrawlingSessionInfoCQ extends BsCrawlingSessionInfoCQ {
     ...
     */
    public CrawlingSessionInfoCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
