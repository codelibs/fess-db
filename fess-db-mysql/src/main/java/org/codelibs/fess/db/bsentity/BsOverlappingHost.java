...
public abstract class BsOverlappingHost extends AbstractEntity implements DomainEntity {
    ...
    /**
     * [get] REGULAR_NAME: {NotNull, TEXT(65535)} <br>
    ...
    /**
     * [set] REGULAR_NAME: {NotNull, TEXT(65535)} <br>
    ...
    /**
     * [get] OVERLAPPING_NAME: {NotNull, TEXT(65535)} <br>
    ...
    /**
     * [set] OVERLAPPING_NAME: {NotNull, TEXT(65535)} <br>
