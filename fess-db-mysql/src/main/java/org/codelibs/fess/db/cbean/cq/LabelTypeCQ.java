...
import org.codelibs.fess.db.cbean.cq.bs.BsLabelTypeCQ;
...
public class LabelTypeCQ extends BsLabelTypeCQ {
     ...
     */
    public LabelTypeCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
