...
public class SearchLogDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, null, false, null, null, null, "clickLogList,searchFieldLogList", null, false);
    protected final ColumnInfo _columnSearchWord = cci("SEARCH_WORD", "SEARCH_WORD", null, null, String.class, "searchWord", null, false, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnResponseTime = cci("RESPONSE_TIME", "RESPONSE_TIME", null, null, Integer.class, "responseTime", null, false, false, true, "INT", 10, 0, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnQueryOffset = cci("QUERY_OFFSET", "QUERY_OFFSET", null, null, Integer.class, "queryOffset", null, false, false, true, "INT", 10, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnQueryPageSize = cci("QUERY_PAGE_SIZE", "QUERY_PAGE_SIZE", null, null, Integer.class, "queryPageSize", null, false, false, true, "INT", 10, 0, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnReferer = cci("REFERER", "REFERER", null, null, String.class, "referer", null, false, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignUserInfo() {
        ...
        return cfi("SEARCH_LOG_ibfk_1", "userInfo", this, UserInfoDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "searchLogList", false);
    }
    ...
    public ReferrerInfo referrerClickLogList() {
        ...
        return cri("CLICK_LOG_ibfk_1", "clickLogList", this, ClickLogDbm.getInstance(), mp, false, "searchLog");
    }
    /**
    ...
    public ReferrerInfo referrerSearchFieldLogList() {
        ...
        return cri("SEARCH_FIELD_LOG_ibfk_1", "searchFieldLogList", this, SearchFieldLogDbm.getInstance(), mp, false, "searchLog");
    }
