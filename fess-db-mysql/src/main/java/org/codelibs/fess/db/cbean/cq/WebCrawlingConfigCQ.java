...
import org.codelibs.fess.db.cbean.cq.bs.BsWebCrawlingConfigCQ;
...
public class WebCrawlingConfigCQ extends BsWebCrawlingConfigCQ {
     ...
     */
    public WebCrawlingConfigCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
