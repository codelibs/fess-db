...
public class WebConfigToLabelTypeMappingDbm extends AbstractDBMeta {
    ...
    public ForeignInfo foreignLabelType() {
        ...
        return cfi("WEB_CONFIG_TO_LABEL_TYPE_MAPPING_ibfk_1", "labelType", this, LabelTypeDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "webConfigToLabelTypeMappingList", false);
    }
    /**
    ...
    public ForeignInfo foreignWebCrawlingConfig() {
        ...
        return cfi("WEB_CONFIG_TO_LABEL_TYPE_MAPPING_ibfk_2", "webCrawlingConfig", this, WebCrawlingConfigDbm.getInstance(), mp, 1, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "webConfigToLabelTypeMappingList", false);
    }
