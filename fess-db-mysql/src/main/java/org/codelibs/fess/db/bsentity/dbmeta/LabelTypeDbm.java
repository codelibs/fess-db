...
public class LabelTypeDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, null, false, null, null, null, "dataConfigToLabelTypeMappingList,fileConfigToLabelTypeMappingList,labelTypeToRoleTypeMappingList,webConfigToLabelTypeMappingList", null, false);
    ...
    public ReferrerInfo referrerDataConfigToLabelTypeMappingList() {
        ...
        return cri("DATA_CONFIG_TO_LABEL_TYPE_MAPPING_ibfk_2", "dataConfigToLabelTypeMappingList", this, DataConfigToLabelTypeMappingDbm.getInstance(), mp, false, "labelType");
    }
    /**
    ...
    public ReferrerInfo referrerFileConfigToLabelTypeMappingList() {
        ...
        return cri("FILE_CONFIG_TO_LABEL_TYPE_MAPPING_ibfk_1", "fileConfigToLabelTypeMappingList", this, FileConfigToLabelTypeMappingDbm.getInstance(), mp, false, "labelType");
    }
    /**
    ...
    public ReferrerInfo referrerLabelTypeToRoleTypeMappingList() {
        ...
        return cri("LABEL_TYPE_TO_ROLE_TYPE_MAPPING_ibfk_1", "labelTypeToRoleTypeMappingList", this, LabelTypeToRoleTypeMappingDbm.getInstance(), mp, false, "labelType");
    }
    /**
    ...
    public ReferrerInfo referrerWebConfigToLabelTypeMappingList() {
        ...
        return cri("WEB_CONFIG_TO_LABEL_TYPE_MAPPING_ibfk_1", "webConfigToLabelTypeMappingList", this, WebConfigToLabelTypeMappingDbm.getInstance(), mp, false, "labelType");
    }
