...
public class CrawlingSessionInfoDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((CrawlingSessionInfo)et).getIdKey(), (et, vl) -> ((CrawlingSessionInfo)et).setIdKey((String)vl), "idKey");
    ...
    protected final ColumnInfo _columnIdKey = cci("ID_KEY", "ID_KEY", null, null, String.class, "idKey", null, false, false, true, "VARCHAR", 20, 0, null, false, null, null, null, null, null, false);
     ...
     * @return The information object of specified column. (NotNull)
     */
    public ColumnInfo columnIdKey() { return _columnIdKey; }
    /**
    ...
    public ForeignInfo foreignCrawlingSession() {
        ...
        return cfi("CRAWLING_SESSION_INFO_ibfk_1", "crawlingSession", this, CrawlingSessionDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "crawlingSessionInfoList", false);
    }
