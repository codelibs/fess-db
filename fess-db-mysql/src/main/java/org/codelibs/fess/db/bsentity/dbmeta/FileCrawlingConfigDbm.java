...
public class FileCrawlingConfigDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, null, false, null, null, null, "fileAuthenticationList,fileConfigToLabelTypeMappingList,fileConfigToRoleTypeMappingList", null, false);
    ...
    protected final ColumnInfo _columnPaths = cci("PATHS", "PATHS", null, null, String.class, "paths", null, false, false, true, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnIncludedPaths = cci("INCLUDED_PATHS", "INCLUDED_PATHS", null, null, String.class, "includedPaths", null, false, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnExcludedPaths = cci("EXCLUDED_PATHS", "EXCLUDED_PATHS", null, null, String.class, "excludedPaths", null, false, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnIncludedDocPaths = cci("INCLUDED_DOC_PATHS", "INCLUDED_DOC_PATHS", null, null, String.class, "includedDocPaths", null, false, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnExcludedDocPaths = cci("EXCLUDED_DOC_PATHS", "EXCLUDED_DOC_PATHS", null, null, String.class, "excludedDocPaths", null, false, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    ...
    public ReferrerInfo referrerFileAuthenticationList() {
        ...
        return cri("FILE_AUTHENTICATION_ibfk_1", "fileAuthenticationList", this, FileAuthenticationDbm.getInstance(), mp, false, "fileCrawlingConfig");
    }
    /**
    ...
    public ReferrerInfo referrerFileConfigToLabelTypeMappingList() {
        ...
        return cri("FILE_CONFIG_TO_LABEL_TYPE_MAPPING_ibfk_2", "fileConfigToLabelTypeMappingList", this, FileConfigToLabelTypeMappingDbm.getInstance(), mp, false, "fileCrawlingConfig");
    }
    /**
    ...
    public ReferrerInfo referrerFileConfigToRoleTypeMappingList() {
        ...
        return cri("FILE_CONFIG_TO_ROLE_TYPE_MAPPING_ibfk_1", "fileConfigToRoleTypeMappingList", this, FileConfigToRoleTypeMappingDbm.getInstance(), mp, false, "fileCrawlingConfig");
    }
