...
import org.codelibs.fess.db.cbean.cq.bs.BsWebAuthenticationCQ;
...
public class WebAuthenticationCQ extends BsWebAuthenticationCQ {
     ...
     */
    public WebAuthenticationCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
