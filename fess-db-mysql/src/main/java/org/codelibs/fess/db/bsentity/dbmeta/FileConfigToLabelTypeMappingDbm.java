...
public class FileConfigToLabelTypeMappingDbm extends AbstractDBMeta {
    ...
    public ForeignInfo foreignFileCrawlingConfig() {
        ...
        return cfi("FILE_CONFIG_TO_LABEL_TYPE_MAPPING_ibfk_2", "fileCrawlingConfig", this, FileCrawlingConfigDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "fileConfigToLabelTypeMappingList", false);
    }
    /**
    ...
    public ForeignInfo foreignLabelType() {
        ...
        return cfi("FILE_CONFIG_TO_LABEL_TYPE_MAPPING_ibfk_1", "labelType", this, LabelTypeDbm.getInstance(), mp, 1, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "fileConfigToLabelTypeMappingList", false);
    }
