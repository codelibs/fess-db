...
import org.codelibs.fess.db.cbean.cq.bs.BsBoostDocumentRuleCQ;
...
public class BoostDocumentRuleCQ extends BsBoostDocumentRuleCQ {
     ...
     */
    public BoostDocumentRuleCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
