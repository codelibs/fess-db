 ...
 */
public abstract class BsSearchWordRanking extends AbstractEntity implements CustomizeEntity {
    ...
    //                                                                           Attribute
    //                                                                           =========
    /** name: {VARCHAR(21845), refers to SEARCH_LOG.SEARCH_WORD} */
    ...
    public DBMeta asDBMeta() {
        return org.codelibs.fess.db.bsentity.customize.dbmeta.SearchWordRankingDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSearchWordRanking) {
            BsSearchWordRanking other = (BsSearchWordRanking)obj;
    ...
    //                                                                            ========
    /**
     * [get] name: {VARCHAR(21845), refers to SEARCH_LOG.SEARCH_WORD} <br>
    ...
    /**
     * [set] name: {VARCHAR(21845), refers to SEARCH_LOG.SEARCH_WORD} <br>
