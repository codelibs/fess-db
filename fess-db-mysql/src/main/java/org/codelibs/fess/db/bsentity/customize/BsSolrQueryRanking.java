 ...
 */
public abstract class BsSolrQueryRanking extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.codelibs.fess.db.bsentity.customize.dbmeta.SolrQueryRankingDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSolrQueryRanking) {
            BsSolrQueryRanking other = (BsSolrQueryRanking)obj;
