...
public abstract class BsCrawlingSession extends AbstractEntity implements DomainEntity {
    ...
    /**
     * [get] EXPIRED_TIME: {NotNull, TIMESTAMP(19), default=[CURRENT_TIMESTAMP]} <br>
    ...
    /**
     * [set] EXPIRED_TIME: {NotNull, TIMESTAMP(19), default=[CURRENT_TIMESTAMP]} <br>
    ...
    /**
     * [get] CREATED_TIME: {NotNull, TIMESTAMP(19), default=[0000-00-00 00:00:00]} <br>
    ...
    /**
     * [set] CREATED_TIME: {NotNull, TIMESTAMP(19), default=[0000-00-00 00:00:00]} <br>
