...
public class BsCrawlingSessionInfoCQ extends AbstractBsCrawlingSessionInfoCQ {
    ...
    protected ConditionValue _idKey;
    public ConditionValue xdfgetIdKey()
    { if (_idKey == null) { _idKey = nCV(); }
      return _idKey; }
    protected ConditionValue xgetCValueIdKey() { return xdfgetIdKey(); }
     ...
     * @return this. (NotNull)
     */
    public BsCrawlingSessionInfoCQ addOrderBy_IdKey_Asc() { regOBA("ID_KEY"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsCrawlingSessionInfoCQ addOrderBy_IdKey_Desc() { regOBD("ID_KEY"); return this; }
