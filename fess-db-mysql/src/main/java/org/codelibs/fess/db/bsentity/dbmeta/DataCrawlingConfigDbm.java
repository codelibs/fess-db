...
public class DataCrawlingConfigDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnId = cci("ID", "ID", null, null, Long.class, "id", null, true, true, true, "BIGINT", 19, 0, null, false, null, null, null, "dataConfigToLabelTypeMappingList,dataConfigToRoleTypeMappingList", null, false);
    ...
    protected final ColumnInfo _columnHandlerParameter = cci("HANDLER_PARAMETER", "HANDLER_PARAMETER", null, null, String.class, "handlerParameter", null, false, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnHandlerScript = cci("HANDLER_SCRIPT", "HANDLER_SCRIPT", null, null, String.class, "handlerScript", null, false, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null, false);
    ...
    public ReferrerInfo referrerDataConfigToLabelTypeMappingList() {
        ...
        return cri("DATA_CONFIG_TO_LABEL_TYPE_MAPPING_ibfk_1", "dataConfigToLabelTypeMappingList", this, DataConfigToLabelTypeMappingDbm.getInstance(), mp, false, "dataCrawlingConfig");
    }
    /**
    ...
    public ReferrerInfo referrerDataConfigToRoleTypeMappingList() {
        ...
        return cri("DATA_CONFIG_TO_ROLE_TYPE_MAPPING_ibfk_1", "dataConfigToRoleTypeMappingList", this, DataConfigToRoleTypeMappingDbm.getInstance(), mp, false, "dataCrawlingConfig");
    }
