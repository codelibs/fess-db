...
public class BoostDocumentRuleCIQ extends AbstractBsBoostDocumentRuleCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BoostDocumentRuleCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsBoostDocumentRuleCQ myCQ) {
    ...
    protected ConditionValue xgetCValueUrlExpr() { return _myCQ.xdfgetUrlExpr(); }
    protected ConditionValue xgetCValueBoostExpr() { return _myCQ.xdfgetBoostExpr(); }
    ...
    public String keepScalarCondition(BoostDocumentRuleCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(BoostDocumentRuleCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(BoostDocumentRuleCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(BoostDocumentRuleCQ sq)
    ...
    protected String xinCB() { return BoostDocumentRuleCB.class.getName(); }
    protected String xinCQ() { return BoostDocumentRuleCQ.class.getName(); }
}
