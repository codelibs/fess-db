 ...
 */
public abstract class BsFavoriteUrlCount extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.codelibs.fess.db.bsentity.customize.dbmeta.FavoriteUrlCountDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsFavoriteUrlCount) {
            BsFavoriteUrlCount other = (BsFavoriteUrlCount)obj;
