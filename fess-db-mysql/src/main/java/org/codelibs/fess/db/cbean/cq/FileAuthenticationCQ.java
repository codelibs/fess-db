...
import org.codelibs.fess.db.cbean.cq.bs.BsFileAuthenticationCQ;
...
public class FileAuthenticationCQ extends BsFileAuthenticationCQ {
     ...
     */
    public FileAuthenticationCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
