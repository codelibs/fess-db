...
public abstract class BsFailureUrl extends AbstractEntity implements DomainEntity {
    ...
    /**
     * [get] ERROR_COUNT: {NotNull, INT(10)} <br>
    ...
    /**
     * [set] ERROR_COUNT: {NotNull, INT(10)} <br>
    ...
    /**
     * [get] LAST_ACCESS_TIME: {NotNull, TIMESTAMP(19), default=[CURRENT_TIMESTAMP]} <br>
    ...
    /**
     * [set] LAST_ACCESS_TIME: {NotNull, TIMESTAMP(19), default=[CURRENT_TIMESTAMP]} <br>
