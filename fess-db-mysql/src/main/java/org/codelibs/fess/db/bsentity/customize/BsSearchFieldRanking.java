 ...
 */
public abstract class BsSearchFieldRanking extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.codelibs.fess.db.bsentity.customize.dbmeta.SearchFieldRankingDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSearchFieldRanking) {
            BsSearchFieldRanking other = (BsSearchFieldRanking)obj;
