 ...
 */
public class BsFavoriteUrlRankingPmb extends SimplePagingBean implements EntityHandlingPmb<FavoriteLogBhv, FavoriteUrlRanking>, AutoPagingHandlingPmb<FavoriteLogBhv, FavoriteUrlRanking>, FetchBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    /** The parameter of fromCreatedTime. */
    protected java.time.LocalDateTime _fromCreatedTime;

    /** The parameter of toCreatedTime. */
    protected java.time.LocalDateTime _toCreatedTime;
     ...
     * {@inheritDoc}
     */
    public String getOutsideSqlPath() { return "selectFavoriteUrlRanking"; }
     ...
     */
    public java.time.LocalDateTime getFromCreatedTime() {
     ...
     */
    public void setFromCreatedTime(java.time.LocalDateTime fromCreatedTime) {
     ...
     */
    public java.time.LocalDateTime getToCreatedTime() {
     ...
     */
    public void setToCreatedTime(java.time.LocalDateTime toCreatedTime) {
