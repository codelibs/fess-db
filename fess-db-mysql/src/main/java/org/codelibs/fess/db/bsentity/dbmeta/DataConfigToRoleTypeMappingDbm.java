...
public class DataConfigToRoleTypeMappingDbm extends AbstractDBMeta {
    ...
    public ForeignInfo foreignDataCrawlingConfig() {
        ...
        return cfi("DATA_CONFIG_TO_ROLE_TYPE_MAPPING_ibfk_1", "dataCrawlingConfig", this, DataCrawlingConfigDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "dataConfigToRoleTypeMappingList", false);
    }
    /**
    ...
    public ForeignInfo foreignRoleType() {
        ...
        return cfi("DATA_CONFIG_TO_ROLE_TYPE_MAPPING_ibfk_2", "roleType", this, RoleTypeDbm.getInstance(), mp, 1, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "dataConfigToRoleTypeMappingList", false);
    }
