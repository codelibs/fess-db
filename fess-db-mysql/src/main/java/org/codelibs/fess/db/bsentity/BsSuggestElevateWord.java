 ...
 */
public abstract class BsSuggestElevateWord extends AbstractEntity implements DomainEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSuggestElevateWord) {
            BsSuggestElevateWord other = (BsSuggestElevateWord)obj;
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_reading));
