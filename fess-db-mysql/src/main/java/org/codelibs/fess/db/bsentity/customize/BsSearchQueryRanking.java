 ...
 */
public abstract class BsSearchQueryRanking extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.codelibs.fess.db.bsentity.customize.dbmeta.SearchQueryRankingDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSearchQueryRanking) {
            BsSearchQueryRanking other = (BsSearchQueryRanking)obj;
    ...
    //                                                                            ========
    /**
     * [get] name: {VARCHAR(21845), refers to SEARCH_FIELD_LOG.VALUE} <br>
    ...
    /**
     * [set] name: {VARCHAR(21845), refers to SEARCH_FIELD_LOG.VALUE} <br>
