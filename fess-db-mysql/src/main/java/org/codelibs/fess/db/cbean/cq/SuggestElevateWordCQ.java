...
import org.codelibs.fess.db.cbean.cq.bs.BsSuggestElevateWordCQ;
...
public class SuggestElevateWordCQ extends BsSuggestElevateWordCQ {
     ...
     */
    public SuggestElevateWordCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
