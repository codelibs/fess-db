...
public class FavoriteLogDbm extends AbstractDBMeta {
    ...
    public ForeignInfo foreignUserInfo() {
        ...
        return cfi("FAVORITE_LOG_ibfk_1", "userInfo", this, UserInfoDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, false, false, false, false, null, null, false, "favoriteLogList", false);
    }
