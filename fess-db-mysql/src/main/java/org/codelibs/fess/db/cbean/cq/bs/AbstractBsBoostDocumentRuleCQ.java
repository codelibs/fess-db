 ...
 */
public abstract class AbstractBsBoostDocumentRuleCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsBoostDocumentRuleCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    protected void doSetUrlExpr_Equal(String urlExpr) {
    ...
    protected void doSetUrlExpr_NotEqual(String urlExpr) {
    ...
    protected void doSetUrlExpr_InScope(Collection<String> urlExprList) {
        regINS(CK_INS, cTL(urlExprList), xgetCValueUrlExpr(), "URL_EXPR");
    }
     ...
     */
    public void setUrlExpr_NotInScope(Collection<String> urlExprList) {
        doSetUrlExpr_NotInScope(urlExprList);
    }

    protected void doSetUrlExpr_NotInScope(Collection<String> urlExprList) {
        regINS(CK_NINS, cTL(urlExprList), xgetCValueUrlExpr(), "URL_EXPR");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * URL_EXPR: {NotNull, TEXT(65535)} <br>
     * <pre>e.g. setUrlExpr_LikeSearch("xxx", op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> op.<span style="color: #CC4747">likeContain()</span>);</pre>
     * @param urlExpr The value of urlExpr as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setUrlExpr_LikeSearch(String urlExpr, ConditionOptionCall<LikeSearchOption> opLambda) {
        setUrlExpr_LikeSearch(urlExpr, xcLSOP(opLambda));
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * URL_EXPR: {NotNull, TEXT(65535)} <br>
     * <pre>e.g. setUrlExpr_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param urlExpr The value of urlExpr as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    protected void setUrlExpr_LikeSearch(String urlExpr, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(urlExpr), xgetCValueUrlExpr(), "URL_EXPR", likeSearchOption);
    }
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setUrlExpr_NotLikeSearch(String urlExpr, ConditionOptionCall<LikeSearchOption> opLambda) {
        setUrlExpr_NotLikeSearch(urlExpr, xcLSOP(opLambda));
    }
     ...
     */
    protected void setUrlExpr_NotLikeSearch(String urlExpr, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(urlExpr), xgetCValueUrlExpr(), "URL_EXPR", likeSearchOption);
    }

    protected void regUrlExpr(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueUrlExpr(), "URL_EXPR"); }
    protected abstract ConditionValue xgetCValueUrlExpr();
    ...
    protected void doSetBoostExpr_Equal(String boostExpr) {
    ...
    protected void doSetBoostExpr_NotEqual(String boostExpr) {
    ...
    protected void doSetBoostExpr_InScope(Collection<String> boostExprList) {
        regINS(CK_INS, cTL(boostExprList), xgetCValueBoostExpr(), "BOOST_EXPR");
    }
     ...
     */
    public void setBoostExpr_NotInScope(Collection<String> boostExprList) {
        doSetBoostExpr_NotInScope(boostExprList);
    }

    protected void doSetBoostExpr_NotInScope(Collection<String> boostExprList) {
        regINS(CK_NINS, cTL(boostExprList), xgetCValueBoostExpr(), "BOOST_EXPR");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * BOOST_EXPR: {NotNull, TEXT(65535)} <br>
     * <pre>e.g. setBoostExpr_LikeSearch("xxx", op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> op.<span style="color: #CC4747">likeContain()</span>);</pre>
     * @param boostExpr The value of boostExpr as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setBoostExpr_LikeSearch(String boostExpr, ConditionOptionCall<LikeSearchOption> opLambda) {
        setBoostExpr_LikeSearch(boostExpr, xcLSOP(opLambda));
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * BOOST_EXPR: {NotNull, TEXT(65535)} <br>
     * <pre>e.g. setBoostExpr_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param boostExpr The value of boostExpr as likeSearch. (NullAllowed: if null (or empty), no condition)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    protected void setBoostExpr_LikeSearch(String boostExpr, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(boostExpr), xgetCValueBoostExpr(), "BOOST_EXPR", likeSearchOption);
    }
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setBoostExpr_NotLikeSearch(String boostExpr, ConditionOptionCall<LikeSearchOption> opLambda) {
        setBoostExpr_NotLikeSearch(boostExpr, xcLSOP(opLambda));
    }
     ...
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    protected void setBoostExpr_NotLikeSearch(String boostExpr, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(boostExpr), xgetCValueBoostExpr(), "BOOST_EXPR", likeSearchOption);
    }

    protected void regBoostExpr(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueBoostExpr(), "BOOST_EXPR"); }
    protected abstract ConditionValue xgetCValueBoostExpr();
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_Equal()</span>.max(new SubQuery&lt;BoostDocumentRuleCB&gt;() {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_NotEqual()</span>.max(new SubQuery&lt;BoostDocumentRuleCB&gt;() {
     *     public void query(BoostDocumentRuleCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;BoostDocumentRuleCB&gt;() {
     *     public void query(BoostDocumentRuleCB subCB) {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessThan()</span>.max(new SubQuery&lt;BoostDocumentRuleCB&gt;() {
     *     public void query(BoostDocumentRuleCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;BoostDocumentRuleCB&gt;() {
     *     public void query(BoostDocumentRuleCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;BoostDocumentRuleCB&gt;() {
     *     public void query(BoostDocumentRuleCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSSQOption<CB> op) {
        ...
        BoostDocumentRuleCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
    ...
    protected BoostDocumentRuleCB xcreateScalarConditionCB() {
        BoostDocumentRuleCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected BoostDocumentRuleCB xcreateScalarConditionPartitionByCB() {
        BoostDocumentRuleCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<BoostDocumentRuleCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        BoostDocumentRuleCB cb = new BoostDocumentRuleCB(); cb.xsetupForDerivedReferrer(this);
    ...
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        BoostDocumentRuleCB cb = new BoostDocumentRuleCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "ID";
     ...
     */
    public void myselfExists(SubQuery<BoostDocumentRuleCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        BoostDocumentRuleCB cb = new BoostDocumentRuleCB(); cb.xsetupForMyselfExists(this);
    ...
    protected String xabCQ() { return BoostDocumentRuleCQ.class.getName(); }
