 ...
 */
public abstract class BsUserAgentRanking extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.codelibs.fess.db.bsentity.customize.dbmeta.UserAgentRankingDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsUserAgentRanking) {
            BsUserAgentRanking other = (BsUserAgentRanking)obj;
